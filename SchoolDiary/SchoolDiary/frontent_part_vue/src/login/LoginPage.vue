<template>
    <div>
        <div class="alert alert-info">
            <strong>ШКОЛЬНЫЙ ДНЕВНИК</strong>
        </div>
        ...
        <form @submit.prevent="onSubmit">
            <div class="form-group">
                ...
                <div v-if="submitted && !$v.username.required" class="invalid-feedback">Логин не может быть пустым</div>
            </div>
            <div class="form-group">
                ...
                <div v-if="submitted && !$v.password.required" class="invalid-feedback">Пароль не может быть пустым</div>
            </div>
            <div class="form-group">
